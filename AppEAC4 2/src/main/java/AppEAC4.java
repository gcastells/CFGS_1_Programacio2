...
public class AppEAC4 {
    ...
    public static String AFS_MESSAGE = "Introdueixi el seu nom";
    public static final String AFS_ERROR = "No s'ha introduït cap informació.";
    //AFS = AskForString
    public static final String AFF_MESSAGE = "Introdueixi la nota de l'exàmen";
    public static final String AFF_ERROR = "El valor introduït no és un nombre";
    //AFF = AskForFloat

    public static final String AFI_MESSAGE = "Introdueixi la seva edat";
    public static final String AFI_ERROR = "El valor introduït no és un nombre sencer";
    //AFI = AskForInteger
    ...
    private void start() {
        //askForString(AFS_MESSAGE, AFS_ERROR);
        //askForInteger(AFI_MESSAGE, AFI_ERROR);
        //askForFloat(AFF_MESSAGE, AFF_ERROR);
    }
